...
- (void)createSceneContents {
    ...
    if( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad ) {
        ...
        tutorialRect = CGRectMake(self.frame.size.width/5, self.frame.size.height/7, 228 * deviceMulti, 380 * deviceMulti);
        ...
        tutorialRect = CGRectMake(self.frame.size.width/7, self.frame.size.height/7, 228 * deviceMulti, 380 * deviceMulti);
        scorePosition = CGPointMake(self.size.width/2, self.size.height/1.7);
    }
